  ...
  sockets: {
    ...
    OrderIsAcceptRestaurant: function () {
      ...
      if (payloadUser.role == "Client") {
        if (Notification.permission === "granted") {
          new Notification(
            "Votre commande a été acceptée par le restaurateur!"
          );
        }
      }
      if (payloadUser.role == "Livreur") {
        if (Notification.permission === "granted") {
          new Notification("Une nouvelle commande est en attente de livraison");
        }
      }
    },
    OrderIsAcceptLivreur: function () {
      ...
      if (payloadUser.role == "Restaurateur") {
        if (Notification.permission === "granted") {
          new Notification("La commande a été acceptée par le livreur!");
        }
      }

      if (payloadUser.role == "Client") {
        if (Notification.permission === "granted") {
          new Notification("Votre commande a été acceptée par le livreur!");
        }
      }
    },
